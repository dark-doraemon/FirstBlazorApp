...
See example  ->  Pages/Iexample.razor
...
See example  -> Pages/DefaultEvent.razor
...
See example  ->  Pages/EventPropagation.razor
...
See example  ->  Pages/DataBinding.razor

>> 5. Changing the Default Binding Event – “@bind-event”

See example  ->  Pages/DefaultBinding.razor
...
See example  ->  Pages/DateTimeFormatted.razor
